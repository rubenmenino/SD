...
public class GeneralRepository implements RepositoryInterface, SharedRegion {
	/**
	...
	/**
	 * estados anteriores dos passageiros
	 */
	private int[] passAnteriorState;
	
	/**
	 * estados anteriores do piloto
	 */
	private int pilotAnteriorState;
	
	/**
	 * estados anteriores da hospedeira
	 */
	...
	public GeneralRepository (String logFileName)
   {
      ...
      passengerState = new int [RunParameters.N+1];
      passAnteriorState = new int [RunParameters.N+1];
	...
	private void reportStatus() {
		...
		case PilotState.FLYING_BACK:
			lineStatus += " FLBK ";
			lineStatus += "ppilotAnteriorState////////////////" + pilotAnteriorState;
	...
	/**
	 * informa��o do numero de voos e do numero de passageiros nele
	 */
